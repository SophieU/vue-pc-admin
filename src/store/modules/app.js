               ...
               if(!child.children){
                 ...
                 if(child.meta.hideChild){
                   ...
                   if(groundFilter.length>0){
                      ...
                      if(hasRoleAuth){
                        child.children.push({path:'editRole',meta:{hideInMenu:true},title:'设置角色',name:'editRole',component:()=>import('@/pages/system/role-setting')},)
                      }
                      return true;
                    }
                 }
